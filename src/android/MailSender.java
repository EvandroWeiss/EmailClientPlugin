...
public class MailSender extends javax.mail.Authenticator {
    ...
    if (!_user.equals("") && !_pass.equals("") && _to.length > 0 && !_from.equals("") && !_subject.equals("")
      ...
      try {
        ...
        */
        ...
        if(_attachment != null){
          _multipart.addBodyPart(_attachment);
        }
        if(!_html){
  ...
  public void addAttachment(String src, String filename) throws Exception {
    BodyPart messageBodyPart = new MimeBodyPart();
    DataSource source = new FileDataSource(Environment.getExternalStoreDirectory() + src);
    messageBodyPart.setDataHandler(new DataHandler(source));
    messageBodyPart.setFileName(filename);
    //_multipart.addBodyPart(messageBodyPart);
    _attachment = messageBodyPart;
  }
